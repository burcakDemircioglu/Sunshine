 ...
 */
package com.example.burcakdemircioglu.sunshine.app.data;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        assertTrue("Error: No Records returned from weather query", c.moveToNext());

        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: Weather query validation failed", c, weatherTestValues);

        assertFalse("Error:More than one records found in the table as results of the query", c.moveToNext());
    ...
    public long insertLocation() {
        ...
        //If there is just one record in the database as the query result
